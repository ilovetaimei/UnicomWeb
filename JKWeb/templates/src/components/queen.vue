<template>
    <div id="q">
            <div class="queen"  id="canvas"></div>
    </div>
</template>
<script>
import  '@/resource/js/qunee-min.js'
export default {
     name: 'Queen',
     data(){
         return{
     ...
     methods:{
         drawDiagram :function(){
                ...
                node1.image = Q.Graphs.server;
                node1.setStyle(Q.Styles.BORDER, 1);
                // node1.setStyle(Q.Styles.BORDER_COLOR, 'RED');
                node1.setStyle(Q.Styles.BACKGROUND_COLOR, 'RED');
                node1.setStyle(Q.Styles.PADDING, 5);
                ...
                var node7 = graph.createNode("007", 300, 300);
                ...
                var edge2 = createEdge(node3, node5, Q.Consts.EDGE_TYPE_VERTICAL_HORIZONTAL, 4);
